	...
	case FG_ASOC:
		value.intval = -1;
		{
			...
			if (!psy_fg) {
				...
				{
					ret = power_supply_get_property(psy_fg,
...
static int sec_battery_probe(struct platform_device *pdev)
{
	...
	battery->psy_bat_desc.name = "battery";
	battery->psy_bat_desc.type = POWER_SUPPLY_TYPE_BATTERY;
	battery->psy_bat_desc.properties = sec_battery_props;
	battery->psy_bat_desc.num_properties = ARRAY_SIZE(sec_battery_props);
	battery->psy_bat_desc.get_property = sec_bat_get_property;
	battery->psy_bat_desc.set_property = sec_bat_set_property;
	battery->psy_usb_desc.name = "usb";
	battery->psy_usb_desc.type = POWER_SUPPLY_TYPE_USB;
	battery->psy_usb_desc.properties = sec_power_props;
	battery->psy_usb_desc.num_properties = ARRAY_SIZE(sec_power_props);
	battery->psy_usb_desc.get_property = sec_usb_get_property;
	battery->psy_ac_desc.name = "ac";
	battery->psy_ac_desc.type = POWER_SUPPLY_TYPE_MAINS;
	battery->psy_ac_desc.properties = sec_ac_props;
	battery->psy_ac_desc.num_properties = ARRAY_SIZE(sec_ac_props);
	battery->psy_ac_desc.get_property = sec_ac_get_property;
	battery->psy_wireless_desc.name = "wireless";
	battery->psy_wireless_desc.type = POWER_SUPPLY_TYPE_WIRELESS;
	battery->psy_wireless_desc.properties = sec_wireless_props;
	battery->psy_wireless_desc.num_properties = ARRAY_SIZE(sec_wireless_props);
	battery->psy_wireless_desc.get_property = sec_wireless_get_property;
	battery->psy_wireless_desc.set_property = sec_wireless_set_property;
	battery->psy_ps_desc.name = "ps";
	battery->psy_ps_desc.type = POWER_SUPPLY_TYPE_POWER_SHARING;
	battery->psy_ps_desc.properties = sec_ps_props;
	battery->psy_ps_desc.num_properties = ARRAY_SIZE(sec_ps_props);
	battery->psy_ps_desc.get_property = sec_ps_get_property;
	battery->psy_ps_desc.set_property = sec_ps_set_property;
	battery->psy_pogo_desc.name = "pogo";
	battery->psy_pogo_desc.type = POWER_SUPPLY_TYPE_POGO;
	battery->psy_pogo_desc.properties = sec_pogo_props;
	battery->psy_pogo_desc.num_properties = ARRAY_SIZE(sec_pogo_props);
	battery->psy_pogo_desc.get_property = sec_pogo_get_property;
	battery->psy_pogo_desc.set_property = sec_pogo_set_property;
	...
	/* init power supplier framework */
	{
		...
		battery->psy_pogo = power_supply_register(&pdev->dev, &battery->psy_pogo_desc, &psy_cfg);
		...
		battery->psy_ps = power_supply_register(&pdev->dev, &battery->psy_ps_desc, &psy_cfg);
		...
		battery->psy_bat = power_supply_register(&pdev->dev, &battery->psy_bat_desc, &psy_cfg);
