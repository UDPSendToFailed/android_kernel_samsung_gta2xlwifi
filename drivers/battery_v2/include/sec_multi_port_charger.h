...
struct sec_multi_charger_platform_data {
	...
	int siop_sub_current_max;		/* In case SIOP_LEVEL is 100 */
	int siop_sub_current_min;		/* In case SIOP_LEVEL is under 100 */
	int pogo_wcin_sub_current;		/* In case cable_type is POGO_WCIN */
	int min_charging_current;		/* the vlaue of min charging current for each charger */
};
...
void get_prev_sub_charging_current(struct sec_battery_info *battery, int * charging_current,
		int * main_charging_current, int * sub_charging_current);
void get_sub_charging_current(struct sec_battery_info *battery, int * charging_current,
