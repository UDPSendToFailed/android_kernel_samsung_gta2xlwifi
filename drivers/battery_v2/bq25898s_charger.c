		...
		const struct i2c_device_id *id)
{
	...
	charger->psy_chg_desc.name           = "bq25898s-charger";
	charger->psy_chg_desc.type           = POWER_SUPPLY_TYPE_UNKNOWN;
	charger->psy_chg_desc.get_property   = bq25898s_chg_get_property;
	charger->psy_chg_desc.set_property   = bq25898s_chg_set_property;
	charger->psy_chg_desc.properties     = bq25898s_charger_props;
	charger->psy_chg_desc.num_properties = ARRAY_SIZE(bq25898s_charger_props);
