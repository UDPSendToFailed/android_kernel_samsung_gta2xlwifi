...
#if defined(CONFIG_MSM_AVTIMER) && __has_include(<linux/avtimer_kernel.h>)
#include <linux/avtimer_kernel.h>
#else
static inline int avcs_core_open(void) { return 0; }
static inline int avcs_core_disable_power_collapse(int disable) { return 0; }
static inline int avcs_core_query_timer(uint64_t *avtimer_tick) { return -ENODEV; }
#endif
