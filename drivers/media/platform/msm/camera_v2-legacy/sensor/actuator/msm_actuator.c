...
#define PARK_LENS_QUIET_UPPER_CODE 500
#define PARK_LENS_QUIET_LOWER_CODE 100
#define PARK_LENS_QUIET_STEP 10
#endif
	...
	const struct i2c_device_id *id)
{
	...
	act_ctrl_t->msm_sd.sd.entity.function = MEDIA_ENT_F_V4L2_SUBDEV_UNKNOWN;
...
static int32_t msm_actuator_platform_probe(struct platform_device *pdev)
{
	...
	msm_actuator_t->msm_sd.sd.entity.function = MEDIA_ENT_F_V4L2_SUBDEV_UNKNOWN;
