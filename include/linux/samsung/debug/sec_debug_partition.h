...
#else
static inline bool read_debug_partition(enum debug_partition_index index,
		void *value)
{
	return true;
}
static inline bool write_debug_partition(enum debug_partition_index index,
		void *value)
{
	return true;
}
...
static inline int dbg_partition_notifier_register(struct notifier_block *nb)
{
	return 0;
}
#endif
