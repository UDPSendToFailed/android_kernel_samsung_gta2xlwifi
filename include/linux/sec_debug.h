...
extern void sec_debug_upload_cause_str(enum sec_debug_upload_cause_t type,
		char *str, size_t len);
...
static inline void sec_debug_upload_cause_str(enum sec_debug_upload_cause_t type,
		char *str, size_t len) {}
...
#undef __SEC_DEBUG_PARTITION_INDIRECT
